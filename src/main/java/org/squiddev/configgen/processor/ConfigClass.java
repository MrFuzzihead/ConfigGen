...
public class ConfigClass {
    ...
    public ConfigClass(TypeElement type, ProcessingEnvironment env) {
        ...
        languagePrefix = config.languagePrefix()
            .isEmpty() ? null : config.languagePrefix();
            ...
            switch (element.getKind()) {
                ...
                case METHOD:
                    if (element.getAnnotation(OnSync.class) != null) {
                        ...
                        if (sync != null) {
                            env.getMessager()
                                .printMessage(Diagnostic.Kind.ERROR, "Cannot have multiple @OnSync instances", element);
                        }
